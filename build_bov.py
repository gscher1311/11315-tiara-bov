...
.buyer-split{display:grid;grid-template-columns:1fr 1fr;gap:28px;align-items:start;}.buyer-split-left{}.buyer-split-right{}.obj-item{margin-bottom:16px;}.obj-q{font-weight:700;color:#1B3A5C;margin-bottom:4px;font-size:14px;}.obj-a{font-size:13px;color:#444;line-height:1.6;}.bp-closing{font-size:13px;color:#444;margin-top:12px;font-style:italic;}.buyer-photo{width:100%;height:220px;border-radius:8px;overflow:hidden;box-shadow:0 2px 12px rgba(0,0,0,0.08);margin-top:24px;}.buyer-photo img{width:100%;height:100%;object-fit:cover;object-position:center;display:block;}
...
<h3 class="sub-heading" style="margin-top:0;">Target Buyer Profile</h3>
<div class="obj-item"><p class="obj-q">Owner-Users</p><p class="obj-a">Occupy one unit and rent the remaining three, benefiting from favorable residential financing (80-85% LTV).</p></div>
<div class="obj-item"><p class="obj-q">Small-Portfolio Investors</p><p class="obj-a">Building a Fannie/Freddie-eligible residential rental portfolio with 30-year fixed-rate financing.</p></div>
<div class="obj-item"><p class="obj-q">Mid-Term Rental Operators</p><p class="obj-a">Leveraging the furnished JADU and utilities-included strategy for premium rents.</p></div>
<div class="obj-item"><p class="obj-q">1031 Exchange Buyers</p><p class="obj-a">Deploying capital into a stabilized, recently renovated asset with minimal near-term CapEx.</p></div>
<p class="bp-closing">Broad appeal across buyer segments supports competitive pricing and multiple offer scenarios.</p>
</div>
